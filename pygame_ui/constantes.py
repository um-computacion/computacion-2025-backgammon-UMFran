...
UNIT_WIDTH = ANCHO // 15 # Ancho base para barras y triángulos
...
# --- COLORES ---
COLOR_FONDO_PRINCIPAL = (220, 190, 160) 
...
COLOR_TEXTO_MENU = (139, 69, 19)
COLOR_BOTON = (180, 136, 99)
COLOR_BOTON_HOVER = (200, 156, 119)
# --- MODIFICACIÓN: Cambiar color de error a uno más visible en barra central ---
...
# --- NUEVO: Fuente específica para el error en la barra central (puede ser igual a FONT_MENSAJE) ---
FONT_ERROR_CENTRAL = pygame.font.SysFont('Arial', 16, bold=True)


# --- ZONAS DE CLIC ---
X_START_TABLERO = ANCHO_BARRA_LATERAL
X_CENTRO_REAL = X_START_TABLERO + (ANCHO_TRIANGULO * 6) + (ANCHO_BARRA_CENTRAL // 2)

ZONA_BARRA_IZQUIERDA = pygame.Rect(0, 0, ANCHO_BARRA_LATERAL, ALTO_TABLERO)
ZONA_BARRA_CENTRAL = pygame.Rect(X_CENTRO_REAL - ANCHO_BARRA_CENTRAL // 2, 0, ANCHO_BARRA_CENTRAL, ALTO_TABLERO)
ZONA_HOME_NEGRO = pygame.Rect(ANCHO - ANCHO_HOME, 0, ANCHO_HOME, ALTO_TABLERO // 2)
ZONA_HOME_BLANCO = pygame.Rect(ANCHO - ANCHO_HOME, ALTO_TABLERO // 2, ANCHO_HOME, ALTO_TABLERO // 2)

INFO_BAR_RECT = pygame.Rect(0, ALTO_TABLERO, ANCHO, INFO_BAR_HEIGHT)
BOTON_ROLL_DICE_RECT = pygame.Rect(20, ALTO_TABLERO + INFO_BAR_HEIGHT // 2 - 20, 150, 40)
BOTON_END_TURN_RECT = pygame.Rect(ANCHO - 170, ALTO_TABLERO + INFO_BAR_HEIGHT // 2 - 20, 150, 40)
...
# --- NUEVO: Posición para el mensaje de error en la barra central ---
POS_ERROR_CENTRAL = (ZONA_BARRA_CENTRAL.centerx, ALTO_TABLERO - 30) # Cerca del borde inferior de la barra
