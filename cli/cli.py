...
class cli:
    ...
    def inicar_juego(self):
        ...
        nombre1 = str(input(
            "Ingrese el nombre del primer jugador (fichas blancas): "
        ))
        nombre2 = str(input(
            "Ingrese el nombre del segundo jugador (fichas negras): "
        ))
        self.__game__ = BackgammonGame(nombre1, nombre2)
        print(
            f"El juego se inició, {nombre1} le tocan fichas blancas "
            f"y {nombre2} le tocan fichas negras"
        )
